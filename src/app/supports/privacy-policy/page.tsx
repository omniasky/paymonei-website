          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <article className="flex-1 min-w-0 max-w-3xl">
              ...
              <Section id="information-we-collect" title="2. Information We Collect">
                ...
                <CalloutBox>
                  Paymonei does not collect, verify, or store government-issued identity documents, beneficial ownership declarations, or Ultimate Beneficial Owner (UBO) data. We do not conduct Anti-Money Laundering (AML) or Counter-Terrorism Financing (CFT) screening. These compliance activities, where applicable to a transaction, are performed exclusively by our licensed financial execution partners under their own independently regulated compliance frameworks.
                </CalloutBox>

                <h3>2.2 From Transaction Participants</h3>
