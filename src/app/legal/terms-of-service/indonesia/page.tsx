          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <article className="flex-1 min-w-0 max-w-3xl">
              ...
              <Section id="penafian" title="9. Penafian Jaminan">
                ...
                <h3>9.2 Bukan Lembaga Keuangan; Tidak Menyediakan Layanan Valuta Asing</h3>
                <p>
                  Anda mengakui bahwa PT Evora Vera Teknologi maupun Omniasky Technology Pte Ltd bukan bank, lembaga jasa keuangan (LJK), bisnis jasa keuangan, lembaga keuangan berlisensi, pedagang valuta asing (PVA), atau penyelenggara jasa penukaran valuta asing. Kami semata-mata bertanggung jawab atas penyampaian perangkat lunak dan konektivitas data. Kami memfasilitasi perutean instruksi alur pembayaran Anda ke Mitra Eksekusi berlisensi kami dan tidak bertanggung jawab atas tindakan, kelalaian, kesalahan, atau kegagalan pihak ketiga mana pun, termasuk namun tidak terbatas pada: (a) pengoperasian jaringan, sistem perbankan, atau infrastruktur keuangan; (b) keputusan Mitra Eksekusi untuk menolak, menunda, membatasi, atau membalik suatu transaksi; atau (c) gangguan pada sistem atau layanan pihak ketiga mana pun.
                </p>
                <p>
                  <strong>Paymonei tidak menyediakan layanan valuta asing, layanan konversi mata uang, atau layanan penukaran valuta asing dalam bentuk apa pun.</strong> Kami tidak bertindak sebagai penghubung antara Anda dan pedagang valuta asing, penyedia konversi mata uang, atau lembaga penukaran valuta asing mana pun. Kami tidak menerima surat kuasa atau mandat untuk melaksanakan transaksi konversi mata uang atas nama Anda, dan tidak ada ketentuan dalam Perjanjian ini yang dapat ditafsirkan sebagai pemberian kewenangan semacam itu. Apabila konversi mata uang terjadi sebagai bagian yang tidak terpisahkan dari suatu transaksi pembayaran yang diproses melalui Layanan, konversi tersebut dilakukan secara eksklusif oleh Mitra Eksekusi berlisensi yang relevan berdasarkan lisensi regulatoris, syarat layanan, dan kebijakan nilai tukar mereka sendiri. Anda harus merujuk langsung kepada syarat layanan Mitra Eksekusi yang berlaku untuk informasi mengenai nilai tukar, finalitas konversi, serta hak dan kewajiban terkait.
                </p>
