...
export const metadata: Metadata = {
  title: { absolute: "Privacy Policy | Paymonei" },
  description:
            ...
            <article className="flex-1 min-w-0 max-w-3xl">
              ...
              <Section id="how-we-use" title="3. How We Use Your Information">
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>Registering and provisioning a merchant business account and enabling access to our software</td>
                    ...
                    <tr>
                      <td>Sending automated dunning, reminder, and receipt notifications on behalf of merchants</td>
                      <td>Performance of contract</td>
                    </tr>
                    <tr>
                      <td>Operating technology-layer risk controls (velocity monitoring, device scoring, suspicious pattern detection) to protect platform integrity</td>
                      <td>Legitimate interest (fraud prevention and platform security)</td>
                    </tr>
                    <tr>
                      <td>Forwarding device context (IP, user agent) to licensed execution partners for transaction fraud scoring</td>
                      <td>Legitimate interest (fraud prevention)</td>
                    </tr>
                    <tr>
                      <td>Retaining identity verification records and merchant onboarding data for regulatory audit trail purposes</td>
                      <td>Legal obligation / Legitimate interest (regulatory readiness)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>Complying with a court order, regulatory demand, banking partner inquiry, or applicable law</td>
                      <td>Legal obligation</td>
                    </tr>
                    <tr>
                      <td>Establishing, exercising, or defending legal claims</td>
                      <td>Legitimate interest (legal protection)</td>
                    </tr>
                  </tbody>
                </table>
                <p>
              ...
              <Section id="how-we-share" title="4. How We Share Information">
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><strong>Fraud Prevention & Risk Signal Providers</strong></td>
                    ...
                    <tr>
                      <td><strong>Legal & Governmental Authorities</strong></td>
                      <td>Where required by a court order, subpoena, governmental inquiry, regulatory demand, or applicable law. We notify affected merchants where legally permitted.</td>
                    </tr>
                    <tr>
                      <td><strong>Prospective Buyers or Acquirers</strong></td>
                      <td>In the event of a merger, acquisition, or asset sale, data may be disclosed to advisers and transferred to new owners. Merchants will be notified before data becomes subject to a different privacy policy.</td>
                    </tr>
                  </tbody>
                </table>
                <p>
